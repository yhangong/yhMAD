...
public class AscendingOrder extends AppCompatActivity {
    ...
    private void isAscendingOrder() {
        // Create a copy of the selectedNumbers array
        ...
        for (int i = 0; i < selectedNumbersList.size(); i++) {
            if (answerNumberList.get(i) != selectedNumbersList.get(i)) {
                isCorrect = false; // Numbers are not in ascending order
                break;
            }
        }
        ...
        if (isCorrect) {// Numbers are in ascending order
            ...
            alertDialogBuilder.setMessage("Numbers are in ascending order!");
            ...
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(this);
            alertDialogBuilder.setTitle("Game Over");
            alertDialogBuilder.setMessage("Numbers are not in ascending order!");
            alertDialogBuilder.setCancelable(false);
            alertDialogBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
